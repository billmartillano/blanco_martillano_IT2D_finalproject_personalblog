    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="edit.php">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label" style="position:relative; top:7px;">Zodiac:</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="zodiac" value="<?php echo $row->zodiac; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label" style="position:relative; top:7px;">Crush:</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="crush" value="<?php echo $row->crush; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
